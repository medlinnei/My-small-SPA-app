<template>
        ...
        <form @submit.prevent="update">
            ...
            <div>
                <button class="ml-auto hover:bg-white hover:text-sky-500 blog p-2 block border border-sky-500 bg-sky-500 rounded-full text-center text-white" type="submit">Update</button>
            </div>
        </form>
</template>
